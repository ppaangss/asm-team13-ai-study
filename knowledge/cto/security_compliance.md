...
| AI Act (EU) | EU 시장 진출 시 | 고위험 AI 시스템 요건 (2024년 시행) |

### AI 규제 동향 (2024~2025년)

```
국내:
- 개인정보보호위원회: AI 개인정보보호 자율점검표 발표 (2023)
- 과기정통부: AI 안전 가이드라인 (생성형 AI 대상)
- 의료 AI: 식약처 의료기기 소프트웨어 가이드라인 적용

해외:
- EU AI Act: 2024년 8월 발효, 고위험 AI에 적합성 평가 의무
- 미국 AI 행정명령 (2023): 안전·보안 기준 수립
- 중국: 생성형 AI 규제 (2023년 8월 시행)
```
